...
<div class="mt-12 border-t pt-8">
	...
	{:else}
		<div class="p-4 bg-gray-100 border border-gray-200 rounded-md text-gray-700 text-sm">
			Будь ласка, <a href="/auth/login" class="font-medium text-indigo-600 hover:underline">увійдіть</a>
			або <a href="/auth/register" class="font-medium text-indigo-600 hover:underline">зареєструйтеся</a>,
