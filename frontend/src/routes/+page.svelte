...
<svelte:head>
  ...
  <meta name="description" content="Останні новини політики, економіки, культури та спорту." />
</svelte:head>

<div class="p-4 md:p-8 min-h-screen">
  <div class="grid grid-cols-[1fr_auto] gap-8 max-w-7xl mx-auto">
    <div class="space-y-6">
      <h1 class="text-4xl font-bold text-gray-900 border-b border-gray-200 pb-4">Останні новини</h1>
      ...
      {:else}
        <div class="bg-white p-12 rounded-lg shadow-md text-center">
          <p class="text-gray-600 text-lg">Наразі немає опублікованих статей.</p>
        </div>
      {/if}
