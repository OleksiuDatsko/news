...
<div class="max-w-4xl mx-auto">
  ...
  <p class="text-lg text-gray-600 mb-8">
    Це ваш особистий кабінет. Тут ви можете керувати своїми налаштуваннями, підписками та
    збереженими статтями.
  </p>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
    ...
    >
      ...
      <p class="mt-1 text-sm text-gray-500">Переглянути статті, які ви відмітили лайком.</p>
      <div class="mt-4 text-sm font-medium text-indigo-600 group-hover:text-indigo-700">
        Перейти &rarr;
      </div>
    </a>
    ...
    >
      ...
      <p class="mt-1 text-sm text-gray-500">Переглянути список авторів, на яких ви підписані.</p>
      <div class="mt-4 text-sm font-medium text-indigo-600 group-hover:text-indigo-700">
        Перейти &rarr;
      </div>
    </a>
    ...
    >
      ...
      <p class="mt-1 text-sm text-gray-500">Керувати сповіщеннями та улюбленими темами.</p>
      <div class="mt-4 text-sm font-medium text-indigo-600 group-hover:text-indigo-700">
        Перейти &rarr;
      </div>
    </a>
    ...
    >
      ...
      <p class="mt-1 text-sm text-gray-500">Переглянути всі отримані сповіщення.</p>
      <div class="mt-4 text-sm font-medium text-indigo-600 group-hover:text-indigo-700">
        Перейти &rarr;
      </div>
    </a>
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg border border-gray-100">
    ...
    <Button onclick={handleLogout} {loading} class="!w-auto !bg-red-600 hover:!bg-red-700">
      Вийти з акаунту
    </Button>
  </div>
</div>
