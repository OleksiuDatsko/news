...
<svelte:head>
  <title>Вподобані статті</title>
</svelte:head>

<div class="max-w-4xl mx-auto">
  <a href="/profile" class="text-indigo-600 hover:underline text-sm">&larr; Назад до профілю</a>
  <h1 class="text-3xl font-bold text-gray-900 mt-2 mb-8">Мої вподобані статті</h1>
  ...
  {:else}
    <div class="bg-white p-12 rounded-lg shadow-md text-center">
      <p class="text-gray-600 text-lg">Ви ще не вподобали жодної статті.</p>
