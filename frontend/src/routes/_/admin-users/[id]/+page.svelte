  ...
  <div class="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
    <form onsubmit={handleSubmit} class="space-y-6">
      ...
      <div class="flex gap-4">
        <Button type="submit" {loading} class="!w-auto">Встановити новий пароль</Button>
        <a
          href="/_/admin-users"
...
{:else}
  ...
  <Alert type="error">Не вдалося завантажити дані. Можливо, адміністратора було видалено.</Alert>
{/if}
