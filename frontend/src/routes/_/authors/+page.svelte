<script lang="ts">
  ...
  async function handleDelete(authorId: number) {
    ...
    if (
      !confirm('Ви впевнені, що хочете видалити цього автора? Це неможливо, якщо у нього є статті.')
    ) {
      return;
    }
    ...
    try {
      ...
      error = e.message || 'Помилка видалення автора. Можливо, у нього є статті.';
    } finally {
      loadingAction = false;
    }
  }
...
<div class="bg-white shadow-lg rounded-lg overflow-hidden">
  ...
  {:else}
    <div class="text-center p-12">
      ...
      <h3 class="mt-2 text-lg font-medium text-gray-900">Жодного автора не знайдено</h3>
      <p class="mt-1 text-sm text-gray-500">Почніть додавати авторів, які будуть писати статті.</p>
      <div class="mt-6">
